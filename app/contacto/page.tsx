            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <div className="max-w-2xl mx-auto">
                ...
                <div className="bg-gray-800/50 border-gray-700 backdrop-blur-sm rounded-2xl p-8 shadow-lg">
                  <h2 className="text-3xl font-bold font-heading text-white mb-6 text-center">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="text-center">
                  ...
                  <p className="text-gray-300">+506 7221-1112</p>
                </div>
                <div className="text-center">
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-300">Soporte técnico 24/7 disponible</p>
                </div>
              </div>
            </div>
          </section>
